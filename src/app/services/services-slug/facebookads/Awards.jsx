...
const awardsData = [
  {
    ...
    description: 'We create highly targeted ad campaigns based on audience insights, ensuring your message reaches the right people at the right time.',
  },
  {
    icon: '/image/services/shop-home-icon-img2.webp',
    title: 'Creative Ad Content',
    description: 'Our team designs eye-catching ad visuals and compelling copy that grabs attention, engages your audience, and encourages action.',
  },
  {
    icon: '/image/services/shop-home-icon-img3.webp',
    title: 'Performance Optimization',
    description: 'We continuously monitor and optimize your campaigns using data-driven insights to maximize ROI and improve ad performance.',
  },
];
