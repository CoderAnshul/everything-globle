            ...
            <Slider {...settings}>
                ...
                <div className={`relative mb-[40px]`}>
                    ...
                    <div className={`border border-black w-[80%] ml-auto -mt-14 relative bg-white flex flex-col justify-start space-y-4 p-4 sm:p-8 rounded-2xl`}>
                        ...
                        <div className={`text-black/90 text-sm sm:text-base`}>
                            <p>Codeyes Media’s email marketing services have been essential in nurturing our leads and boosting conversions. Their personalized email campaigns are tailored perfectly to our audience.</p>
                        </div>
                    </div>
                ...
                <div className={`relative mb-[40px]`}>
                    ...
                    <div className={`border border-black w-[80%] ml-auto -mt-14 relative bg-white flex flex-col justify-start space-y-4 p-4 sm:p-8 rounded-2xl`}>
                        ...
                        <div className={`text-black/90 text-sm sm:text-base`}>
                            <p>We’ve seen an increase in both open rates and conversions thanks to the email marketing services from Codeyes Media. Their team really knows how to craft engaging emails that get results.</p>
                        </div>
                    </div>
                    <div className="absolute -bottom-5 -right-0 border border-black bg-[#cbdec6] rounded-xl p-3">
                        <MdFormatQuote className='text-3xl' />
                ...
                <div className={`relative mb-[40px]`}>
                    ...
                    <div className={`border border-black w-[80%] ml-auto -mt-14 relative bg-white flex flex-col justify-start space-y-4 p-4 sm:p-8 rounded-2xl`}>
                        ...
                        <div className={`text-black/90 text-sm sm:text-base`}>
                            <p>Codeyes Media’s email marketing has been a huge asset to our business. Their strategy and design helped us build strong customer relationships and encourage repeat purchases.</p>
                        </div>
                    </div>
                    <div className="absolute -bottom-5 -right-0 border border-black bg-[#cbdec6] rounded-xl p-3">
                        <MdFormatQuote className='text-3xl' />
