...
const awardsData = [
  {
    ...
    description: 'We create personalized email campaigns tailored to your audience’s preferences, ensuring relevant content that resonates and drives action.',
  },
  {
    icon: '/image/services/shop-home-icon-img2.webp',
    title: 'Engaging Design & Copy',
    description: 'Our team designs visually appealing emails with compelling copy that encourages opens, clicks, and conversions.',
  },
  {
    icon: '/image/services/shop-home-icon-img3.webp',
    title: 'Performance Tracking & Optimization',
    description: 'We monitor campaign performance, using analytics to refine strategies and maximize open rates, click-through rates, and ROI.',
  },
];
