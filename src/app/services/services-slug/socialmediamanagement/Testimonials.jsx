        ...
        <Slider {...settings}>
            ...
            <div className={`relative mb-[40px]`}>
                ...
                <div className={`border border-black w-[80%] ml-auto -mt-14 relative bg-white flex flex-col justify-start space-y-4 p-4 sm:p-8 rounded-2xl`}>
                    ...
                    <div className={`text-black/90 text-sm sm:text-base`}>
                        <p>Codeyes Media has completely transformed our social media presence. Their team is incredibly strategic, and they’ve helped us grow our followers, engagement, and ultimately our brand loyalty.</p>
                    </div>
                </div>
            ...
            <div className={`relative mb-[40px]`}>
                ...
                <div className={`border border-black w-[80%] ml-auto -mt-14 relative bg-white flex flex-col justify-start space-y-4 p-4 sm:p-8 rounded-2xl`}>
                    ...
                    <div className={`text-black/90 text-sm sm:text-base`}>
                        <p>Working with Codeyes Media for our social media management has been a game-changer. They created a content strategy that perfectly aligned with our brand and helped us engage with our audience in a meaningful way.</p>
                    </div>
                </div>
                <div className="absolute -bottom-5 -right-0 border border-black bg-[#cbdec6] rounded-xl p-3">
                    <MdFormatQuote className='text-3xl' />
            ...
            <div className={`relative mb-[40px]`}>
                ...
                <div className={`border border-black w-[80%] ml-auto -mt-14 relative bg-white flex flex-col justify-start space-y-4 p-4 sm:p-8 rounded-2xl`}>
                    ...
                    <div className={`text-black/90 text-sm sm:text-base`}>
                        <p>Codeyes Media's approach to social media management has given us the results we needed. They understand the trends, know how to engage, and have brought a fresh voice to our online presence.</p>
                    </div>
                </div>
                <div className="absolute -bottom-5 -right-0 border border-black bg-[#cbdec6] rounded-xl p-3">
                    <MdFormatQuote className='text-3xl' />
